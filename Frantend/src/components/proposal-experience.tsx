...
import { loadPublishedProposal, type PhotoItem, type ProposalData } from "@/lib/proposal-storage";
import { getCustomProposalRenderer } from "@/components/proposal-template-renderers";
...
export default function ProposalExperience() {
  ...
  const customRenderer = tpl ? getCustomProposalRenderer(tpl.proposalId) : null;

  if (customRenderer && tpl) {
